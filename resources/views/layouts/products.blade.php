...
<head>
    ...
    <title>TechHub - E-Commerce</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-products shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    Tech<span class="text-primary">Hub</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">{{ __('Deals') }}</a>
                        </li>
                    </ul>
